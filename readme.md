...
<p align="center">
<img src="./images/mnist_50_epoch.jpg" alt="drawing" height="600" width="650"/>
</p>

<p align="center">
<img src="./images/train_300.jpg" alt="drawing" height="600" width="650"/>
</p>
...
EMA update adapted from [yiyixuxu](https://github.com/yiyixuxu/denoising-diffusion-flax) is performed using the following equation
$$
    p_{t + 1} = (1.0 - d) \, p_{old} + (d) p_{new} 
$$ 
